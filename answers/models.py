...
class Episode(models.Model):
    ...
    def __str__(self):
        return f'Episode Number: {self.show_number}, Air Date: {self.air_date}'

class Category(models.Model):
    show_number = models.ForeignKey(Episode, on_delete = models.CASCADE)
    ...
    def __str__(self):
        return f'Episode: {self.show_number}, Category: {self.category}, Round: {self.round}'
